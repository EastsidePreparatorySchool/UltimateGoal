...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    private final static double mm = 1 / 25.4;

    public static double TICKS_PER_REV = 8192;
    public static double WHEEL_RADIUS = 19 * mm; // in
    public static double GEAR_RATIO = 1; // output (wheel) speed / input (encoder) speed

    public static double LATERAL_DISTANCE = 11.83; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -120 * mm; // in; offset of the lateral wheel
